...
% --- Executes during object creation, after setting all properties.
function globalYedit_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function globalXtext_CreateFcn(hObject, eventdata, handles)
% hObject    handle to globalXtext (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
newScale = round(get(hObject,'Value'),1);
newScales = repmat(newScale,8,1);
rec = getappdata(handles.mainWindow, 'recorder');
rec.axesData(:,1) = newScales;
